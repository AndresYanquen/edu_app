  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { requiresAuth: true, requiresStaff: true, roles: ['admin', 'instructor', 'content_editor'], cmsCourseTabKey: 'build' },
      },
      {
        path: 'groups',
      ...
      },
      {
        ...
        meta: { requiresAuth: true, requiresStaff: true, roles: ['admin', 'instructor', 'content_editor'], cmsCourseTabKey: 'announcements' },
      },
      {
        path: 'posts',
        name: 'cms-course-posts',
        component: CmsCoursePostsRouteTab,
        meta: { requiresAuth: true, requiresStaff: true, roles: ['admin', 'instructor', 'content_editor'], cmsCourseTabKey: 'posts' },
      },
      {
        path: 'forums',
        name: 'cms-course-forums',
        component: CmsCourseForumsTab,
        meta: { requiresAuth: true, requiresStaff: true, roles: ['admin', 'instructor', 'content_editor'], cmsCourseTabKey: 'forums' },
      },
      {
        path: 'live-sessions',
      ...
      },
      {
        ...
        meta: { requiresAuth: true, requiresStaff: true, roles: ['admin', 'instructor'], cmsCourseTabKey: 'instructors' },
      },
      {
        path: 'enrollments',
      ...
      },
      {
        ...
        meta: { requiresAuth: true, requiresStaff: true, roles: ['admin'], cmsCourseTabKey: 'staff' },
      },
    ],
  },
  {
    ...
    meta: { requiresAuth: true, requiresStaff: true, roles: ['admin', 'instructor', 'content_editor'] },
  },
  {
    path: '/',
    name: 'landing',
